...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-36892-p-vs-pspace-3fec167a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-36892"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-36892-p-vs-pspace-3fec167a-v1",
      "problem_contract_sha256": "25a04e0b525b2a93d64662afaf165922b38a95b03cce794cb98e214aa189a6f5",
      "problem_id": "problem:um-opg-36892-p-vs-pspace-3fec167a",
      "route_id": "route:um-opg-36892-p-vs-pspace-3fec167a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-36892-p-vs-pspace-3fec167a-source-fidelity-01",
      "graph_id": "graph:um-opg-36892-p-vs-pspace-3fec167a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-36892-p-vs-pspace-3fec167a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-36892-p-vs-pspace-3fec167a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Problem Is there a problem that can be computed by a Turing machine in polynomial space and unbounded time but not in polynomial time? More formally, does P = PSPACE?"
          },
          "statement_sha256": "847a3adbf49557fcbf2b9c386672f1fd865827c025ed6b7ebd83cb1668deb87d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-36892-p-vs-pspace-3fec167a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-36892-p-vs-pspace-3fec167a-root",
      "route_id": "route:um-opg-36892-p-vs-pspace-3fec167a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-36892-25bbefb0ec94",
        "url": "https://www.unsolvedmath.com/problems/OPG-36892"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
